package bn.com.userdefinedtargetssample.BnUtils;//声明包
...
{
	public static int initTexture(String resource,Resources r)//textureId
	{
		//生成纹理ID
	...
	public static int initTexture(int drawableId,Resources r)//textureId
	{
		//生成纹理ID
		int[] textures = new int[1];
		GLES30.glGenTextures
    ...
    (String fname, Resources r,SurfaceView mv)
    {
    	//加载后物体的引用
